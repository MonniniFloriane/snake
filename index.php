...
<main class="container p-3">
    ...
    <section class="mb-5">
        <form action="add_modify.php" method="post">
            ...
            <fieldset class="text-uppercase" Ajouter un serpent>
                <h2 class="text-uppercase fw-light mb-4">Ajouter un serpent</h2>
                ...
                <div class="mt-5 d-md-flex gap-2 justify-content-md-end">
                    ...
                    <button class="btn btn-success fw-bold rounded-5" type="submit">
                        <i class="fa-solid fa-plus"></i>
                        AJOUTER UN SERPENT
                    </button>

                    <button class="btn btn-outline-danger rounded-5" type="reset">
    ...
    <section>
        <h2 class="mb-4 text-uppercase fw-light">Liste de serpent</h2>
        <!--FILTRE-->
        <div class="dropdown border border-dark-subtle d-flex justify-content-between">
            <a href="index.php?tri=name" class="btn btn-dark">
                <i class="fa-solid fa-arrow-down-a-z"></i>
                Ordre alphabétique
            </a>

            <a href="index.php?tri=birth DESC" class="btn btn-dark">
                <i class="fa-solid fa-arrow-down-1-9"></i>
                Date + récente
            </a>

            <a href="index.php?tri=weight DESC" class="btn btn-dark">
                <i class="fa-solid fa-dumbbell"></i>
                Poids ordre décroissant
            </a>

            <a href="index.php?tri=life_time DESC" class="btn btn-dark">
        ...
        <table class="table mt-5">
            <thead>
            <tr class="text-uppercase fw-bold table-active">
                <th>Nom</th>
                <th>Poids</th>
                <th>Durée de Vie</th>
